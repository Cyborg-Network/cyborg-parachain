...
pub use cyborg_primitives::task::{TaskStatusType, TaskType,TaskKind};
...
// 		let task_kind=TaskKind::NeuroZK;
// 		let worker_owner = 2;
// 		let worker_id = 99;
...
// 		let task_kind_0=TaskKind::NeuroZK;
// 		let task_kind_1=TaskKind::OpenInference;
