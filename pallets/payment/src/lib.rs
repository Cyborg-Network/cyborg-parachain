...
pub mod pallet {
	...
	pub type PricePerHour<T: Config> = StorageValue<_, u64, ValueQuery>;

	#[pallet::storage]
	#[pallet::getter(fn get_service_provider_account)]
	pub type ServiceProviderAccount<T: Config> = StorageValue<_, T::AccountId>;
