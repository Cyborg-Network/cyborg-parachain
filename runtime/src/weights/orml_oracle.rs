...
// --output=./runtime/src/weights/orml_oracle.rs
...
impl<T: frame_system::Config> orml_oracle::WeightInfo for SubstrateWeight<T> {
	...
	fn feed_values(x: u32, ) -> Weight {
		...
		Weight::from_parts(10_000_000, 1998)
			// Standard Error: 101_661
			.saturating_add(Weight::from_parts(20_234_832, 0).saturating_mul(x.into()))
