...
// --output=./runtime/src/weights/pallet_task_management.rs
...
impl<T: frame_system::Config> pallet_task_management::WeightInfo for SubstrateWeight<T> {
	...
	fn submit_completed_task(s: u32, ) -> Weight {
		...
		Weight::from_parts(28_008_642, 9096)
			// Standard Error: 641
			.saturating_add(Weight::from_parts(3_904, 0).saturating_mul(s.into()))
	...
	fn verify_completed_task(s: u32, ) -> Weight {
		...
		Weight::from_parts(11_519_089, 3686)
			// Standard Error: 787
			.saturating_add(Weight::from_parts(58, 0).saturating_mul(s.into()))
	...
	fn resolve_completed_task(_s: u32, ) -> Weight {
		...
		//  Estimated: `3686`
		// Minimum execution time: 10_000_000 picoseconds.
		Weight::from_parts(11_569_230, 3686)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
